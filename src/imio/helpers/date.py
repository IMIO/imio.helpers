...
def wordizeDate(date, context=None, long_format=False):
    ...
    converted_date = u"{} {} {}".format(converted_day, converted_month, converted_year)
    ...
    if long_format and date_time:
        ...
        if converted_minutes and minutes not in [
            "0",
            "00",
        ]:
            converted_time = u" {} {} {} {}".format(u"à", converted_hour, hour_word, converted_minutes)
        else:
            # remove the minutes, especially useless spaces if there
            # are no minutes
            converted_time = u" {} {} {}".format(u"à", converted_hour, hour_word)
    if not six.PY3:
